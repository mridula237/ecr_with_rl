...
class Florence2ForConditionalGeneration(Florence2PreTrainedModel):
    ...
    def _merge_input_ids_with_image_features(
        self, image_features, inputs_embeds, audio_features=None
        ):
        ...
        if audio_features is not None:
            # audio_features = 0.9 * text_vec + 0.1 * audio_vec
            inputs_embeds = torch.cat([image_features, task_prefix_embeds, audio_features], dim=1)
        else:
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None:
                ...
                inputs_embeds, attention_mask = self._merge_input_ids_with_image_features(image_features, inputs_embeds, audio_features=audio_features)
